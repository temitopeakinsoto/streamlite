...
# Class to handle video analysis
class EmotionAnalyzer(VideoProcessorBase):
    def __init__(self):
        self.questionnaire_data = './database/questionnaire_data.json'
        self.consent_data = './database/consent_data.json'
        self.questionnaire_data_list = []
        self.consent_data_list = []
    ...
    def consent():
        ...
        if st.button("Submit"):
            ...
            if os.path.exists(self.consent_data):
                with open(self.consent_data, 'r') as json_file:
        ...
        # Implement the code for the consent form
    ...
    def apppage(self):
        ...
        webrtc_ctx = webrtc_streamer(
            ...
            desired_fps=30,
            start_button_label="Start Emotion Analysis",
            stop_button_label="Stop Emotion Analysis",
            player=None,
            processor_factory=self,  # Use the current class as the processor
        )

# Function to run the selected page
